...
class NepaliCalendar extends HTMLElement {
    ...
    selectedDate(day) {
        //get dates
        let date = {
            np: day.getElementsByClassName("np-date")[0].innerHTML.toString().revNepaliNumber(),
            int: day.getElementsByClassName("int-date")[0].innerHTML.toString().revNepaliNumber(),
            task: day.getElementsByClassName("task")[0].innerHTML.toString().revNepaliNumber(),
        };
